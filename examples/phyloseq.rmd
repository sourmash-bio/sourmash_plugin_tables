...
We do not need the TaxID. We do need to match the row names of the sourmash OTU, though. Therefore, we need to collapse the accession and species name into a single string and move that string to the row names
